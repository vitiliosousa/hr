...
export default function FlightsHotels() {
  return (
    <section id="como-funciona" className="w-full bg-gray-50 py-12 sm:py-20 scroll-mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-10">
        <div className="flex flex-col items-center text-center mb-10 sm:mb-14">
          ...
          <h2 className="text-xl sm:text-2xl font-bold">Como funciona</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          {passos.map((passo) => {
            ...
            return (
              <div key={passo.numero} className="bg-white rounded-2xl shadow-sm p-6 sm:p-8 flex flex-col gap-5 border border-gray-100 hover:shadow-md transition-shadow duration-300 relative overflow-hidden">
